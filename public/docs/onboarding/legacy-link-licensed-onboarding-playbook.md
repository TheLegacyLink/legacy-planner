# The Legacy Link — Licensed Agent Onboarding Playbook

## Purpose
This playbook is your **licensed agent launch sequence**.
Complete each step in order, then execute daily standards with clean CRM updates.

---

## Step 1 — ICA Signing + Back Office Access (Required First)

### Part A — Log In
- Go here: **https://innercirclelink.com/start**
- Enter your email. A one-time passcode will be sent to you. Enter it to log in.
- Upon first login, you will be taken through a **mandatory one-time signing sequence** before accessing anything else.

### Part B — ICA Signing Sequence (3 Steps, ~5 Minutes)
...
- Part C (Video tutorial on the contracting process): **https://www.loom.com/share/f8d8c10001054625916adca06348ff03**
