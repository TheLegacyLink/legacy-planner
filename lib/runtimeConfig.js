...
export const DEFAULT_CONFIG = {
  ...
  agentGroups: {
    'Kimora Link': 'inner_circle',
    'Jamal Holmes': 'inner_circle',
    'Mahogany Burns': 'inner_circle',
    'Leticia Wright': 'inner_circle',
    'Andrea Cannon': 'inner_circle',
    'Kelin Brown': 'inner_circle',
    'Madalyn Adams': 'inner_circle',
    'Breanna James': 'inner_circle',
    'Donyell Richardson': 'inner_circle',
    'Shannon Maxwell': 'inner_circle',
    'Angelique Lassiter': 'inner_circle',
    'Mirick Whaley': 'sponsorship',
    'Weiner Merchant Crumbly': 'sponsorship',
    'Deshae Ford': 'sponsorship'
  },
  policyRescue: {
    readUrl: '',
    writeUrl: '',
