...
export const STORE_SEED = {
  ...
  products: [
    ...
    // ─── SWEATSUIT ─────────────────────────────────────────────────────────────
    {
      ...
      image: '/store/store-sweatsuit-black-v2.png',
      colors: [{ label: 'Black', hex: '#0B0B0B', image: '/store/store-sweatsuit-black-v2.png' }],
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL'],
      printfulVariantIds: { S: '', M: '', L: '', XL: '', '2XL': '', '3XL': '' },
      active: true
    },
    ...
    // ─── HATS ──────────────────────────────────────────────────────────────────
    {
      ...
      image: '/store/store-hat-black-v2.png',
      colors: [{ label: 'Black', hex: '#0B0B0B', image: '/store/store-hat-black-v2.png' }],
      sizes: ['One Size'],
