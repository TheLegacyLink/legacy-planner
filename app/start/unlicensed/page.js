    ...
    return (
      <main style={{ minHeight: '100vh', background: '#020617', color: '#F8FAFC', padding: 16, display: 'grid', placeItems: 'center' }}>
        <div style={{ width: 'min(680px, 96vw)', border: '1px solid #334155', borderRadius: 16, background: '#0B1220', padding: 22, textAlign: 'center' }}>
          ...
          <h1 style={{ margin: '6px 0 0' }}>Profile Submitted</h1>
          <p style={{ color: '#94A3B8', marginBottom: 20 }}>
            Your profile is captured. Your next step is to log in and complete your Independent Contractor Agreement — it’s built right into your back office. Takes about 5 minutes.
          </p>
          ...
          <p style={{ color: '#64748B', fontSize: 13, margin: 0 }}>
            Use: <strong style={{ color: '#94A3B8' }}>{form.email}</strong>
          </p>
        </div>
      </main>
    );
