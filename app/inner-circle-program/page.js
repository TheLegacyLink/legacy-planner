  ...
  return (
    <main className="publicPage" style={{ background: '#020617', minHeight: '100vh', color: '#e2e8f0' }}>
      ...
      <div className="panel" style={{ maxWidth: 1100, border: '1px solid #1e293b', background: '#071126' }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18, display: 'grid', gap: 6, color: '#e2e8f0' }}>
          <li>Action-takers who are ready to execute daily</li>
          <li>People open to structure, coaching, and accountability</li>
          <li>People committed to follow-up, consistency, and growth</li>
        </ul>
