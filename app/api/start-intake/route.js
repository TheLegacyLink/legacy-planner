  ...
  const text = contractRequired
    ...
    : (track === 'licensed'
      ? [
          `Hi ${firstName},`,
          '',
          'Execute your next steps in order:',
          '',
