...
export async function POST(req) {
  ...
  const next = {
    ...
    dateKey,
    calls: body?.calls != null ? toNum(body?.calls) : toNum(base?.calls),
    texts: body?.texts != null ? toNum(body?.texts) : toNum(base?.texts),
    followUps: body?.followUps != null ? toNum(body?.followUps) : toNum(base?.followUps),
    bookings: body?.bookings != null ? toNum(body?.bookings) : toNum(base?.bookings),
    sponsorshipApps: body?.sponsorshipApps != null ? toNum(body?.sponsorshipApps) : toNum(base?.sponsorshipApps),
    fngSubmittedApps: body?.fngSubmittedApps != null ? toNum(body?.fngSubmittedApps) : toNum(base?.fngSubmittedApps),
