              ...
              <div style={{ display: 'grid', gap: 10 }}>
                ...
                <div style={{ border: '1px solid #1f2937', borderRadius: 12, padding: 14, background: '#020617' }}>
                  ...
                  <div style={{ display: 'grid', gap: 10, gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))' }}>
                    ...
                    <div style={{ border: '1px solid #1f2937', borderRadius: 10, padding: 10, background: '#030a17' }}><small className="muted">Completed Sponsorship</small><div style={{ color: '#fff', fontWeight: 800, fontSize: 24 }}>{displayedKpi?.completedSponsorship ?? displayedKpi?.closesThisMonth ?? 0}</div><small className="muted">{displayedKpi?.completionRate ?? displayedKpi?.closeRate ?? 0}% of leads</small></div>
                    <div style={{ border: '1px solid #1f2937', borderRadius: 10, padding: 10, background: '#030a17' }}><small className="muted">Submitted App</small><div style={{ color: '#fff', fontWeight: 800, fontSize: 24 }}>{displayedKpi?.submittedApps ?? 0}</div></div>
                    <div style={{ border: '1px solid #1f2937', borderRadius: 10, padding: 10, background: '#030a17' }}><small className="muted">Potential</small><div style={{ color: '#C8A96B', fontWeight: 800, fontSize: 24 }}>${(displayedKpi?.potentialEarned ?? displayedKpi?.grossEarned ?? 0).toLocaleString()}</div><small className="muted">Leads × $500</small></div>
                  </div>
                </div>
