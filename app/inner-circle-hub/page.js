              ...
              <div style={{ display: 'grid', gap: 10 }}>
                ...
                <div style={{ border: '1px solid #1f2937', borderRadius: 12, padding: 14, background: '#020617' }}>
                  ...
                  <div style={{ display: 'grid', gap: 10, gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))' }}>
                    <div style={{ border: '1px solid #1f2937', borderRadius: 10, padding: 10, background: '#030a17' }}><small className="muted">Completed Sponsorship</small><div style={{ color: '#fff', fontWeight: 800, fontSize: 24 }}>{displayedKpi?.leadsReceived ?? 0}</div><small className="muted">Sponsorship form fills</small></div>
